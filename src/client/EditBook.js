          ...
          <section className="hero is-bold is-light is-fullheight-with-navbar ">
            ...
            <div class="card">
              ...
              <figure class="image is-602x300">
               ...
               <img src="https://i.ibb.co/9Yj4VsX/18.jpg" alt="image18" border="0"></img>
            ...
            <div className="is-fluid">
                ...
                <nav className="navbar has-background-danger is-bold ">
                 ...
                 <div className="column">
                  ...
                  <nav class="level-item">
                  <div class="control">
                  <Link to={'/booklist'} className="navbar-item navbar-end">
  ...
  <div class="control">
    <div class="tags has-addons">
      ...
      <span class="tag is-primary">on gitter</span>
               ...
               <img src="https://i.ibb.co/4YRfCGc/12.jpg" alt="image12" ></img>
